...
** 
** Compile:  g++ -o heat heat.c solver.c              // sequential
**           g++ -O -o heat heat.c solver.c           // with optimization
**           g++ -fopenmp -o heat heat.c solver.c     // with OpenMP support
**           g++ -fopenmp -O -o heat heat.c solver.c  // with OpenMP support and optimization
**           mpicc -o heat heat.c solver.c            // with MPI
**           mpicc -O -o heat heat.c solver.c         // with MPI and optimization
**
** Run:      heat <size> [<epsilon>]                  // sequential and OpenMP version
**           mpiexec -n 4 ... heat <size> [<epsilon>] // MPI version
**                <size>      -- Size of matrix
